from fuctions import create_adjacency_matrix, calculate_max_degree_adj, calculate_min_degree_adj, print_adjacency_matrix, show_hist_adj
...
matrix_adj = create_adjacency_matrix(states, edges)
print_adjacency_matrix(matrix_adj)
print()

max_degree_adj = calculate_max_degree_adj(matrix_adj)
print(max_degree_adj)
print()

min_degree_adj = calculate_min_degree_adj(matrix_adj)
